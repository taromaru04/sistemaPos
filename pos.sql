...
(10, 'ECONOMICOS', '2020-02-26 00:46:04'),
(11, 'Mecanismos pesados', '2020-02-26 00:58:53');

--
-- Disparadores `categorias`
--
DELIMITER $$
CREATE TRIGGER `insertcategory` AFTER INSERT ON `categorias` FOR EACH ROW INSERT INTO bd_inventario.categorias SET id = NEW.id,categoria= NEW.categoria,fecha = NEW.fecha
$$
DELIMITER ;
DELIMITER $$
CREATE TRIGGER `updatecategory` AFTER UPDATE ON `categorias` FOR EACH ROW UPDATE bd_inventario.categorias SET id = NEW.id,categoria= NEW.categoria,fecha = NEW.fecha WHERE id = NEW.id
$$
DELIMITER ;
...
--
DELIMITER $$
CREATE TRIGGER `insertcustomers` AFTER INSERT ON `clientes` FOR EACH ROW INSERT INTO bd_ventas.clientes SET id = NEW.id ,nombre = NEW.nombre ,documento = NEW.documento ,email = NEW.email ,telefono = NEW.telefono ,direccion = NEW.direccion ,
fecha_nacimiento = NEW.fecha_nacimiento ,compras = NEW.compras ,ultima_compra = NEW.ultima_compra ,fecha = NEW.fecha
$$
DELIMITER ;
DELIMITER $$
CREATE TRIGGER `updatecustomers` AFTER UPDATE ON `clientes` FOR EACH ROW UPDATE bd_ventas.clientes SET id = NEW.id ,nombre = NEW.nombre ,documento = NEW.documento ,email = NEW.email ,telefono = NEW.telefono ,direccion = NEW.direccion ,
fecha_nacimiento = NEW.fecha_nacimiento ,compras = NEW.compras ,ultima_compra = NEW.ultima_compra ,fecha = NEW.fecha WHERE id = NEW.id
$$
DELIMITER ;
...
(60, 5, '517', 'Cortadora de Baldosin', 'vistas/img/productos/517/746.jpg', 5, 930, 1302, 17, '2020-02-26 01:04:01');

--
-- Disparadores `productos`
--
DELIMITER $$
CREATE TRIGGER `insertproduct` AFTER INSERT ON `productos` FOR EACH ROW INSERT INTO bd_inventario.productos SET id=NEW.id,id_categoria=NEW.id_categoria,codigo=NEW.codigo,descripcion=NEW.descripcion,imagen=NEW.imagen,stock=NEW.stock,precio_compra=NEW.precio_compra,
precio_venta=NEW.precio_venta,ventas=NEW.ventas,fecha=NEW.fecha
$$
DELIMITER ;
DELIMITER $$
CREATE TRIGGER `updateproduct` AFTER UPDATE ON `productos` FOR EACH ROW UPDATE bd_inventario.productos SET id=NEW.id,id_categoria=NEW.id_categoria,codigo=NEW.codigo,descripcion=NEW.descripcion,imagen=NEW.imagen,stock=NEW.stock,precio_compra=NEW.precio_compra,
precio_venta = NEW.precio_venta, ventas = NEW.ventas, fecha = NEW.fecha WHERE id = NEW.id
$$
DELIMITER ;
...
--
DELIMITER $$
CREATE TRIGGER `insertusers` AFTER INSERT ON `usuarios` FOR EACH ROW INSERT INTO bd_ventas.usuarios SET id = NEW.id ,nombre = NEW.nombre ,usuario = NEW.usuario ,password = NEW.password ,perfil = NEW.perfil ,foto = NEW.foto ,estado = NEW.estado ,
ultimo_login = NEW.ultimo_login ,fecha = NEW.fecha
$$
DELIMITER ;
DELIMITER $$
CREATE TRIGGER `updateusers` AFTER UPDATE ON `usuarios` FOR EACH ROW UPDATE bd_ventas.usuarios SET id = NEW.id ,nombre = NEW.nombre ,usuario = NEW.usuario ,password = NEW.password ,perfil = NEW.perfil ,foto = NEW.foto ,estado = NEW.estado ,
ultimo_login = NEW.ultimo_login ,fecha = NEW.fecha  WHERE id = NEW.id
$$
DELIMITER ;
...
--
DELIMITER $$
CREATE TRIGGER `insertsales` AFTER INSERT ON `ventas` FOR EACH ROW INSERT INTO bd_ventas.ventas SET id=id = NEW.id,codigo = NEW.codigo,id_cliente = NEW.id_cliente,id_vendedor = NEW.id_vendedor,productos = NEW.productos,impuesto = NEW.impuesto,
neto = NEW.neto,total = NEW.total,metodo_pago = NEW.metodo_pago,fecha = NEW.fecha
$$
DELIMITER ;
DELIMITER $$
CREATE TRIGGER `updatesales` AFTER UPDATE ON `ventas` FOR EACH ROW UPDATE bd_ventas.ventas SET id = NEW.id,codigo = NEW.codigo,id_cliente = NEW.id_cliente,id_vendedor = NEW.id_vendedor,productos = NEW.productos,impuesto = NEW.impuesto,
neto = NEW.neto,total = NEW.total,metodo_pago = NEW.metodo_pago,fecha = NEW.fecha WHERE id = NEW.id
$$
DELIMITER ;
